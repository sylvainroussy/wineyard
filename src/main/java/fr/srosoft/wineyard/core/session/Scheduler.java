...
import fr.srosoft.wineyard.core.session.ExtenderService.ExtenderExample;

public class Scheduler {
	
    //private ExtenderService extenderService = new ExtenderService();
    ...
    public void onEventResize(ScheduleEntryResizeEvent event) {
        /*acesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event resized",
